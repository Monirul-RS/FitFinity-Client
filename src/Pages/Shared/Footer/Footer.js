...
import icon from '../../../assets/images/Icon/favicon.ico'

const Footer = () => {
    return (
        <div>
            <footer className="footer p-28 bg-zinc-900 text-white">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-zinc-900 text-white border-base-300">
                <div className="items-center grid-flow-col">
                    <img src={icon} className='w-16' alt="" />
                    <p>FitFinity. <br /><p>Copyright © 2022 - All right reserved</p></p>
                </div>
